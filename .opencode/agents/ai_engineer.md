...
## Guidelines
- Follow `.opencode/rules/security_and_error_handling.md` for proper API error responses.
- Consult `.opencode/skills/create_fastapi_endpoint.md` when building new AI features.
